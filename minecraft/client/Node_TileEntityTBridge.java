...
public class Node_TileEntityTBridge extends TileEntity
{

    public Node_TileEntityTBridge()
    {
        index = -1;
        meta = 0;
        daddyX = 0;
    ...
    public void readFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        index = nbttagcompound.getShort("TBridgeInd");
    ...
    public void writeToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setShort("TBridgeInd", (short)index);
    ...
    public boolean canSeeDaddy()
    {
        ...
        i1 += byte0;
        j1 += byte1;
        if(worldObj.getBlockId(i1, yCoord, j1) == mod_Node_LaserBridge.blockTrickBridge.blockID || worldObj.getBlockId(i1, yCoord, j1) == mod_Node_LaserBridge.blockTrickBridgeControl.blockID)
        {
            return true;
        }
