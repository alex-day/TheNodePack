...
public class Node_TileEntityDBridge extends TileEntity
{

    public Node_TileEntityDBridge()
    {
        index = -1;
        meta = 0;
        daddyX = 0;
    ...
    public void readFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        index = nbttagcompound.getShort("DBridgeInd");
    ...
    public void writeToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setShort("DBridgeInd", (short)index);
    ...
    public boolean canSeeDaddy()
    {
        ...
        i1 += byte0;
        j1 += byte1;
        if(worldObj.getBlockId(i1, yCoord, j1) == mod_Node_LaserBridge.blockDeathBridge.blockID || worldObj.getBlockId(i1, yCoord, j1) == mod_Node_LaserBridge.blockDeathBridgeControl.blockID)
        {
            return true;
        }
