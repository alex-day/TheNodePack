...
public class Node_RenderBolt extends Render
{

    public Node_RenderBolt()
    {
    }

    public void func_154_a(Node_EntityBolt entityarrow, double d, double d1, double d2, 
            float f, float f1)
    {
        loadTexture("/NodePack/weapons/bolts.png");
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
        func_154_a(((Node_EntityBolt)entity), d, d1, d2, f, f1);
    }
}
