...
public class Node_BlockIlluminationTube extends Block
{

    protected Node_BlockIlluminationTube(int i, int j)
    {
    ...
    public void onBlockPlaced(World world, int i, int j, int k, int l)
    {
        ...
        {
            world.setBlockWithNotify(i, j, k, mod_Node_IlluminationTube.blockIlluminationTubeRoof.blockID);
    ...
    public void onBlockAdded(World world, int i, int j, int k)
    {
        ...
        boolean flag = func_25271_h(world, i, j, k);
    }

    public void onNeighborBlockChange(World world, int i, int j, int k, int l)
    {
        if(func_25271_h(world, i, j, k))
        {
            int i1 = world.getBlockMetadata(i, j, k);
            boolean flag = false;
    ...
    private boolean func_25271_h(World world, int i, int j, int k)
    {
