...
public class Node_EntityBolt extends Entity
{

    public Node_EntityBolt(World world)
    {
    	super(world);
        xTile = -1;
        yTile = -1;
    ...
    public Node_EntityBolt(World world, double d, double d1, double d2)
    {
    	super(world);
        xTile = -1;
        yTile = -1;
    ...
    public Node_EntityBolt(World world, EntityLiving entityliving)
    {
    	super(world);
        xTile = -1;
        yTile = -1;
            ...
            float f1)
    {
        ...
        d1 *= f;
        d2 *= f;
        motionX = d*SPEED_SCALE;
        motionY = d1*SPEED_SCALE;
        motionZ = d2*SPEED_SCALE;
    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            ...
            {
                if(movingobjectposition.entityHit.attackEntityFrom(owner, BOLT_DAMAGE))
                {
    ...
    public static final int BOLT_DAMAGE = 8;
}
