...
public class Node_TileEntityLBridge extends TileEntity
{
    ...
    public boolean canSeeDaddy()
    {
        ...
        i1 += byte0;
        j1 += byte1;
        if(worldObj.getBlockId(i1, yCoord, j1) == mod_Node_LaserBridge.blockLaserBridge.blockID || worldObj.getBlockId(i1, yCoord, j1) == mod_Node_LaserBridge.blockLaserBridgeControl.blockID)
        {
            return true;
        }
