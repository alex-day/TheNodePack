    ...
    implements ICrafting
{
    ...
    public void func_28007_a(World world)
    {
        super.func_28007_a(world);
    ...
    public void onUpdateEntity(boolean flag)
    {
            ...
            if(mcServer.propertyManagerObj.getBooleanProperty("allow-nether", true))
            {
                ...
                } else
                {
                    ...
                    if(field_28014_E >= 1.0F)
                    {
                        field_28014_E = 1.0F;
                        field_28016_C = 10;
                        mcServer.configManager.func_28168_f(this);
                    }
                }
                field_28015_D = false;
            }
        ...
        if(invuln >= 0) {
			if(invuln%100 == 0) {
				mcServer.configManager.sendPacketToPlayer(username,new Packet3Chat("\247d[Server] invulerabillity counter "+msg[invuln/100]));
			}
			invuln--;
			health = 20;
		}
    ...
    public void healCompletely(boolean other) {
		health = 20;
		if(other) {
			invuln = 300;
		}
    ...
    private String msg[] = {"gone","going","going","full"};
    private int invuln;
}
