...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
		 ...
		 * ------------- START Node Pack ---------------
		 */
        addRecipe(new ItemStack(Block.illuminationTubeFloor, 4), new Object[] {
		...
		addRecipe(new ItemStack(Block.dirtStairs, 4), new Object[] {
            "#  ", "## ", "###", Character.valueOf('#'), Block.dirt
        });
        addRecipe(new ItemStack(Block.stoneStairs, 4), new Object[] {
            "#  ", "## ", "###", Character.valueOf('#'), Block.stone
		});
        addRecipe(new ItemStack(Block.snowStairs, 4), new Object[] {
            "#  ", "## ", "###", Character.valueOf('#'), Block.blockSnow
        });
        addRecipe(new ItemStack(Block.glassStairs, 4), new Object[] {
            "#  ", "## ", "###", Character.valueOf('#'), Block.glass
        });
        addRecipe(new ItemStack(Block.ironStairs, 4), new Object[] {
            "#  ", "## ", "###", Character.valueOf('#'), Block.blockSteel
        });
        addRecipe(new ItemStack(Block.goldStairs, 4), new Object[] {
            "#  ", "## ", "###", Character.valueOf('#'), Block.blockGold
        });
        addRecipe(new ItemStack(Block.diamondStairs, 4), new Object[] {
            "#  ", "## ", "###", Character.valueOf('#'), Block.blockDiamond
        });
        addRecipe(new ItemStack(Block.netherStairs, 4), new Object[] {
            "#  ", "## ", "###", Character.valueOf('#'), Block.bloodStone
        });
        addRecipe(new ItemStack(Block.brickStairs, 4), new Object[] {
            "#  ", "## ", "###", Character.valueOf('#'), Block.brick
        });
		
		addRecipe(new ItemStack(Block.blockFluro, 8, 0), new Object[] {
			"#Y#", "YXY", "#Y#",
			Character.valueOf('#'), Block.glass,
			Character.valueOf('X'), new ItemStack(Block.torchWood),
			Character.valueOf('Y'), new ItemStack(Item.dyePowder, 1, 15)
		});
		addRecipe(new ItemStack(Block.blockFluro, 8, 1), new Object[] {
			"#Y#", "YXY", "#Y#",
			Character.valueOf('#'), Block.glass,
			Character.valueOf('X'), new ItemStack(Block.torchWood),
			Character.valueOf('Y'), new ItemStack(Item.dyePowder, 1, 4)
		});
		addRecipe(new ItemStack(Block.blockFluro, 8, 2), new Object[] {
			"#Y#", "YXY", "#Y#",
			Character.valueOf('#'), Block.glass,
			Character.valueOf('X'), new ItemStack(Block.torchWood),
		...
		addRecipe(new ItemStack(Block.blockLaserBridgeControl), new Object[] {
