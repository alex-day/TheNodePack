...
public class Item
{
	...
	public static Item ingotNether = (new Item(mod_Node_PackLoader.getID("netherIngot"))).setIconCoord(7, 2).setItemName("ingotNether");
	public static Item ingotObsidian = (new Item(mod_Node_PackLoader.getID("obsidianIngot"))).setIconCoord(7, 2).setItemName("ingotObsidian");
	public static Item netherAxe = (new ItemAxe(mod_Node_PackLoader.getID("axeNether"), EnumToolMaterial.NETHER)).setIconIndex(0).setItemName("axeNether");
	public static Item netherHoe = (new ItemHoe(mod_Node_PackLoader.getID("hoeNether"), EnumToolMaterial.NETHER)).setIconIndex(0).setItemName("hoeNether");
	public static Item netherPick = (new ItemPickaxe(mod_Node_PackLoader.getID("pickNether"), EnumToolMaterial.NETHER)).setIconIndex(0).setItemName("pickNether");
	public static Item netherShovel = (new ItemSpade(mod_Node_PackLoader.getID("shovelNether"), EnumToolMaterial.NETHER)).setIconIndex(0).setItemName("shovelNether");
	public static Item netherSword = (new ItemSword(mod_Node_PackLoader.getID("swordNether"), EnumToolMaterial.NETHER)).setIconIndex(0).setItemName("swordNether");
	public static Item obsidianAxe = (new ItemAxe(mod_Node_PackLoader.getID("axeObsidian"), EnumToolMaterial.OBSIDIAN)).setIconIndex(0).setItemName("axeObsidian");
	public static Item obsidianHoe = (new ItemHoe(mod_Node_PackLoader.getID("hoeObsidian"), EnumToolMaterial.OBSIDIAN)).setIconIndex(0).setItemName("hoeObsidian");
	public static Item obsidianPick = (new ItemPickaxe(mod_Node_PackLoader.getID("pickObsidian"), EnumToolMaterial.OBSIDIAN)).setIconIndex(0).setItemName("pickObsidian");
	public static Item obsidianShovel = (new ItemSpade(mod_Node_PackLoader.getID("shovelObsidian"), EnumToolMaterial.OBSIDIAN)).setIconIndex(0).setItemName("shovelObsidian");
	public static Item obsidianSword = (new ItemSword(mod_Node_PackLoader.getID("swordObsidian"), EnumToolMaterial.OBSIDIAN)).setIconIndex(0).setItemName("swordObsidian");
	
    public static Item helmetNether = (new ItemArmor(mod_Node_PackLoader.getID("helmetNether"), 2, 0, 0)).setIconIndex(0).setItemName("helmetNether");
    public static Item plateNether = (new ItemArmor(mod_Node_PackLoader.getID("plateNether"), 2, 0, 1)).setIconIndex(0).setItemName("chestplateNether");
    public static Item legsNether = (new ItemArmor(mod_Node_PackLoader.getID("legsNether"), 2, 0, 2)).setIconIndex(0).setItemName("leggingsNether");
    public static Item bootsNether = (new ItemArmor(mod_Node_PackLoader.getID("bootsNether"), 2, 0, 3)).setIconIndex(0).setItemName("bootsNether");
    public static Item helmetObsidian = (new ItemArmor(mod_Node_PackLoader.getID("helmetObsidian"), 3, 0, 0)).setIconIndex(0).setItemName("helmetObsidian");
    public static Item plateObsidian = (new ItemArmor(mod_Node_PackLoader.getID("plateObsidian"), 3, 0, 1)).setIconIndex(0).setItemName("chestplateObsidian");
    public static Item legsObsidian = (new ItemArmor(mod_Node_PackLoader.getID("legsObsidian"), 3, 0, 2)).setIconIndex(0).setItemName("leggingsObsidian");
    public static Item bootsObsidian = (new ItemArmor(mod_Node_PackLoader.getID("bootsObsidian"), 3, 0, 3)).setIconIndex(0).setItemName("bootsObsidian");
    public static Item mesh = (new Item(mod_Node_PackLoader.getID("mesh"))).setIconIndex(0).setItemName("mesh");
	/*
	 * ------------- END Node Pack ---------------
	 */
