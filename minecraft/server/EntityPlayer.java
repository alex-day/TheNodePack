...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nodeScore = nbttagcompound.getShort("nodeScore");
        if(sleeping)
        {
    ...
    public void writeEntityToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setShort("nodeScore", (short)nodeScore);
        if(spawnChunk != null)
        {
    ...
    public void attackTargetEntityWithCurrentItem(Entity entity)
    {
        ...
        if(i > 0)
        {
            ...
            if(entity instanceof EntityLiving)
            {
                ...
                int damage = itemstack.getDamageVsEntity(livingEntity);
                if(livingEntity instanceof EntityPlayer) {
                	addNodeScore(-100*damage);
                } else if(livingEntity instanceof EntityAnimal) {
    				addNodeScore(2*damage);
    			} else if(livingEntity instanceof EntityMob) {
    				addNodeScore(25*damage);
    			} else if(livingEntity instanceof EntityFlying) {
    				addNodeScore(40*damage);
    			} else {
    				addNodeScore(1*damage);
    			}
            }
        }
    }
     ...
     * @param blockWorth
     */
    public void addNodeScore(int blockWorth) {
		nodeScore += blockWorth;
	}
