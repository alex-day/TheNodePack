...
public class ItemTool extends Item
{
    ...
    {
    	if((block.blockID == Block.obsidian.blockID || block.blockID == Block.oreRedstone.blockID || block.blockID == Block.oreRedstoneGlowing.blockID) && (toolMaterial.equals(EnumToolMaterial.OBSIDIAN) || toolMaterial.equals(EnumToolMaterial.NETHER)))
        {
